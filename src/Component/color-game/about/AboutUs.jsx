    ...
    return (
        <div className="w-full lg:py-[120px] lg:p-4 flex justify-center flex-wrap">
            <div className="w-2/3 flex justify-center flex-wrap lg:flex-nowrap ">
                <div className="lg:w-[200px] w-[150px] lg:h-[200px] h-[150px] bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${require('../../../images/my-brand.png')})` }}></div>
