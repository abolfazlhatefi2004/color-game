            ...
            <nav className="bg-gray-100 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <Link to="/log-up" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Get started</Link>
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2" ref={menu}>
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0" onClick={e => setColor(e)}>
                            <li>
                                <Link to="/" className={`block py-2 pr-4 pl-3 lg:p-0 dark:text-white ${select[0].flag ? itemList.selected : itemList.unSelected}`} data-name={select[0].name}>Home</Link>
                            </li>
                            <li>
                                <Link to="/Description" className={`block py-2 pr-4 pl-3 border-b border-gray-100  lg:border-0 lg:p-0 dark:text-gray-400 ${select[1].flag ? itemList.selected : itemList.unSelected}`} data-name={select[1].name}>Decription</Link>
                            </li>
                            <li>
                                <Link to="/Players" className={`block py-2 pr-4 pl-3 border-b border-gray-100  lg:border-0 lg:p-0 dark:text-gray-400 ${select[2].flag ? itemList.selected : itemList.unSelected}`} data-name={select[2].name}>Players</Link>
                            </li>
                            <li>
                                <Link to="/About-us" className={`block py-2 pr-4 pl-3 border-b border-gray-100  lg:border-0 lg:p-0 dark:text-gray-400 ${select[3].flag ? itemList.selected : itemList.unSelected}`} data-name={select[3].name}>About us</Link>
                            </li>
                        </ul>
                    </div>
                </div>
